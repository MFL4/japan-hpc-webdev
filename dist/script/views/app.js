const app = () => {
    ...
    window.addEventListener("scroll", () => {
        if (window.scrollY > 0) {
            navbarElement.classList.add("bg-primary/10", "backdrop-blur", "mt-0", "py-3", "drop-shadow-md");
            navbarElement.classList.remove("mt-8", "xl:mt-16");
            navlist.classList.remove("-top-8");
            navlist.classList.add("top-0");
        } else {
            navbarElement.classList.remove("bg-primary/10", "backdrop-blur", "mt-0", "py-3", "drop-shadow-md");
            navbarElement.classList.remove("mt-8", "xl:mt-16");
            navlist.classList.remove("-top-8");
            navlist.classList.add("top-0");
        }
